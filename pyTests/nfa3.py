...
if __name__ == "__main__":
    ...
    fa = compute_regex(et)
    arrange_nfa(fa)
    expected = {'states': ['Q1', 'Q2', 'Q3', 'Q4'], 'letters': ['a', '$', 'b'], 'transition_function': [['Q1', 'a', 'Q2'], ['Q2', '$', 'Q3'], ['Q3', 'b', 'Q4']], 'start_states': ['Q1'], 'final_states': ['Q4']}
    run_test(nfa, expected, 'nfa3')
    if display_graph('nfa3'):
        nfa_graph = nfa_to_graphviz(nfa)
        nfa_graph.render('nfa3')

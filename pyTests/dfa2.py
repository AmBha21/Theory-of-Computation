...
if __name__ == "__main__":
    ...
    _nfa = {'states': ['Q1', 'Q2', 'Q3', 'Q4', 'Q5', 'Q6'], 'letters': ['$', 'a', 'b'], 'transition_function': [['Q1', '$', 'Q2'], ['Q1', '$', 'Q3'], ['Q2', 'a', 'Q4'], ['Q4', '$', 'Q5'], ['Q3', 'b', 'Q6'], ['Q6', '$', 'Q5']], 'start_states': ['Q1'], 'final_states': ['Q5']}
    nfa = NFA()
    nfa.set_nfa(_nfa)
    dfa = compute_dfa(nfa.nfa)
    expected = {'states': [{'Q1', 'Q3', 'Q2'}, {'Q6', 'Q5'}, {'Q4', 'Q5'}], 'letters': ['a', 'b'], 'transition_function': [({'Q1', 'Q3', 'Q2'}, 'a', {'Q4', 'Q5'}), ({'Q1', 'Q3', 'Q2'}, 'b', {'Q6', 'Q5'})], 'start_states': [{'Q1', 'Q3', 'Q2'}], 'final_states': [{'Q6', 'Q5'}, {'Q4', 'Q5'}]}
    run_test(dfa, expected, 'dfa2')
    if display_graph('dfa2'):
        create_dfa_graph(dfa, 'dfa2')